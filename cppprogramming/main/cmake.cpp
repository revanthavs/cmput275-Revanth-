...
// void make_target(string target, vector<string>& track, unordered_set<string>& made_target, unordered_map<string, unordered_set<string>>& files){
// 	if ((made_target.find(target) != made_target.end()) || (files.find(target) == files.end())){
// 		return;
// 	}
// 	else{
