...
int main(int argc, char* argv[]) {
  ...
  while(true) {
    ...
    if (buffer[0] == R){
      ...
      // char temp1[p[1].length()] = {};
      // for (int i = 0; i < p[1].length()+1; i++){
      //   temp1[i] = p[1][i];
      // }
      // int temp = 0;
      // temp = atoi(temp1);
      // sPoint.lat = temp;
      // char temp2[p[2].length()] = {};
      // for (int i = 0; i < p[2].length()+1; i++){
      //   temp2[i] = p[2][i];
      // }
      // temp = atoi(temp2);
      // sPoint.lon = temp;

      // char temp3[p[3].length()] = {};
      // for (int i = 0; i < p[3].length()+1; i++){
      //   temp3[i] = p[0][i];
      // }
      // temp = atoi(temp3);
      // ePoint.lat = temp;

      // char temp4[p[4].length()] = {};
      // for (int i = 0; i < p[4].length()+1; i++){
      //   temp4[i] = p[4][i];
      // }
      // temp = atoi(temp4);
      // ePoint.lon = temp;
